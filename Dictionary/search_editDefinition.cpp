...
void search_editDefinition(RenderWindow& window, Trie& trie, string typeDictionary, Trie& favor_trie, Trie& history_trie, string word, int& state) {
	...
	Object check_delete = createObject("content/del_pop.png", 485.0f * scale, 40.0f * scale);
	Object screen = createObject("content/editDefScene.png");
	Info enterEdit = createInfo("content/Oswald-Light.ttf", "New Definition", 510.0f * scale, 120.0f * scale, 26.25f * scale);
	Object canEdit = createObject("content/canEdit.png", 485.0f * scale, 40.0f * scale);
	Object cannotEdit = createObject("content/cannotEdit.png", 450.0f * scale, 0.0f * scale);
	Object ok1 = createObject("content/ok2.png", 655.0f * scale, 165.0f * scale);
	Object ok2 = createObject("content/ok1.png", 655.0f * scale, 165.0f * scale);
	Object ok3 = createObject("content/ok2.png", 655.0f * scale, 165.0f * scale);
	Object ok4 = createObject("content/ok1.png", 655.0f * scale, 165.0f * scale);
	Object return3 = createObject("content/return2.png", 495.0f * scale, 165.0f * scale);
	Object return4 = createObject("content/return3.png", 495.0f * scale, 165.0f * scale);
